...
; Make sure to btrfs balance every day to ensure your data are not
; getting too fragmented, which could cause problems with metadata space.
; I have a crontab entry at midnight  with
...
; concerned about performance than reliability 
; (at which point you should switch to XFS anyway
