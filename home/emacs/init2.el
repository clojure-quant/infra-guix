...
(use-package faces
  :defer t
  :custom-face
  (default ((t (:inherit default :family "Iosevka" :weight light :height 180))))
  (variable-pitch ((t (:inherit variable-pitch :family "Iosevka Etoile" :height 180))))
...
(use-package org-roam
  ...
  :custom
  (org-roam-directory (expand-file-name "~/docs/roam"))
  :config
